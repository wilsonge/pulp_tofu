...
from pulp_tofu.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_tofu import RemotesTofuApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesTofuApi(gen_tofu_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesTofuApi(gen_tofu_client()).create(body)
