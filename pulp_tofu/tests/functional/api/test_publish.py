"""Tests that publish tofu plugin repositories."""
import unittest
...
from pulp_tofu.tests.functional.constants import TOFU_CONTENT_NAME
...
from pulpcore.client.pulp_tofu.exceptions import ApiException
...
class PublishAnyRepoVersionTestCase(unittest.TestCase):
    ...
    * `Pulp Smash #897 <https://github.com/pulp/pulp-smash/issues/897>`_
    ...
    def test_all(self):
        ...
        for tofu_content in get_content(repo.to_dict())[TOFU_CONTENT_NAME]:
            modify_repo(cfg, repo.to_dict(), add_units=[tofu_content])
