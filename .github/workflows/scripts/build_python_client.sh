...
./gen-client.sh "../pulp_tofu/tofu-api.json" "tofu" python "pulp_tofu"

pushd pulp_tofu-client
python -m build

twine check "dist/pulp_tofu_client-"*"-py3-none-any.whl"
twine check "dist/pulp_tofu_client-"*".tar.gz"
...
repo_name: wilsonge/pulp_tofu
repo_url: https://github.com/wilsonge/pulp_tofu
theme: readthedocs
DOCSYAML
